...
namespace ServerCore
{
    ...
    public abstract class Session
    {
        Socket socket;
        int disconnected = 0;
        readonly RecvBuffer recvBuffer = new RecvBuffer(65535);
        readonly object _lock = new object();
        readonly Queue<ArraySegment<byte>> sendQueue = new Queue<ArraySegment<byte>>();
        readonly List<ArraySegment<byte>> pendingList = new List<ArraySegment<byte>>();
